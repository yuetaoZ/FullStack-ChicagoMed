...
insert into doctorcontact(doctorid, doctoremail, doctorphone) values (1, 'michael.jordan@gmail.com', '111-222-1111');
insert into doctorcontact(doctorid, doctoremail, doctorphone) values (2, 'jerry.seinfeld@gmail.com', '111-222-3333');
insert into doctorcontact(doctorid, doctoremail, doctorphone) values (3, 'luke@gmail.com', '111-222-4444');
